...
/**
 * Created by benchengzhou on 2017/7/18  11:00 .
 * 作者邮箱：mappstore@163.com
 * 功能描述：
 * 类    名： SmoothOverScrollview
 * 备    注： 自定义的可以实现平滑过度拉伸的scrollview
 */

public class SmoothOverScrollview extends ScrollView {
    ...
    public SmoothOverScrollview(Context context) {
        super(context);
    }

    public SmoothOverScrollview(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public SmoothOverScrollview(Context context, AttributeSet attrs, int defStyleAttr) {
