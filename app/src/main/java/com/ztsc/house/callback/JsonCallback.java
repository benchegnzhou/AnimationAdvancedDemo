...
public abstract class JsonCallback<T> extends AbsCallback<T> {
    ...
    public void onStart(Request<T, ? extends Request> request) {
        ...
        request.headers("header1", "HeaderValue1")//
                .params("machineId", DeviceMessageUtils.getIMEI(MApplication.sAppContext))//
                .params("machineName", DeviceMessageUtils.getMobileInfo(MApplication.sAppContext))
                .params("clientType", "1");
